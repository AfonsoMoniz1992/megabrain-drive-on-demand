...
> **Public self-hosted beta v0.2.4 — iOS validation is pending.** The release contains only plugin artefacts. It includes no broker, Google OAuth client, callback host, account, token, or Drive data.
