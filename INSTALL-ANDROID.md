...
> **Public self-hosted beta v1.0.5 — Android validation is pending.** The release contains only plugin artefacts. It includes no broker, Google OAuth client, callback host, account, token, or Drive data.
...
3. In BRAT choose **Add beta plugin**, enter this repository's `owner/repository` identifier, then select **v1.0.5**.
