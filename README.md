...
> **Status: public self-hosted beta.** The v0.2.5 release distributes only plugin artefacts: it contains no broker, OAuth client, callback host, Google account or Drive data. Physical iOS/Android vali...[truncated]
...
3. Choose **v0.2.5** and enable **GDriveStreaming Drive on Demand**.
